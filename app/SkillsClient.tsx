  ...
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-8 relative z-10 pt-48">
      <div className="flex justify-center">
        <div className="w-[95%]">
          <div className="mb-32">
            <h1 className="text-7xl md:text-8xl font-bold text-white mb-8">{t('skills.title')}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
            {skillsCategories.map((category, index) => (
              ...
              >
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-10 tracking-wide">{t(category.titleKey)}</h2>

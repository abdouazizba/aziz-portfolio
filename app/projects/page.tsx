...
const projects = [
  {
    ...
    description: 'Un portfolio moderne construit avec Next.js, mettant l\'accent sur le design, les performances et l\'expérience utilisateur. Intégration EmailJS, déploiement sur Vercel avec pipeline CI/CD.',
  ...
  },
  {
    ...
    description: 'Application collaborative pour gérer les tâches avec système de notification en temps réel. Interface intuitive et responsive avec synchronisation Firebase.',
  ...
  },
  {
    ...
    description: 'Plateforme e-commerce complète avec panier d\'achat, système de paiement intégré (Stripe) et tableau de bord administrateur pour la gestion des produits.',
  ...
  {
    id: 4,
    title: 'API RESTful avec Documentation',
    description: 'API robuste et scalable avec authentification JWT, validation de données, gestion des erreurs professionnelle et documentation Swagger complète.',
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 pt-40">
        <div className="container max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Mes Projets</h1>
